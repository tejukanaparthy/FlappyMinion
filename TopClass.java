...
public class TopClass implements ActionListener, KeyListener {
    ...
    private static final int BIRD_WIDTH = 100, BIRD_HEIGHT = 120;
    ...
    private static final int BIRD_JUMP_DIFF = 10, BIRD_FALL_DIFF = BIRD_JUMP_DIFF/2, BIRD_JUMP_HEIGHT = PIPE_GAP*3 - BIRD_HEIGHT - BIRD_JUMP_DIFF;
